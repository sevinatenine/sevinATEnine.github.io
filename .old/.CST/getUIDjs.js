...
// document.getElementById('UID-to-username').innerHTML = (usernames[String(uid)]['users'].join(", ")+" browsing with "+usernames[String(uid)]['browser']+" on a "+usernames[String(uid)]['os']);
// document.write((uid+","+usernames[String(uid)]['users']+","+usernames[String(uid)]['browser']+","+usernames[String(uid)]['os']));